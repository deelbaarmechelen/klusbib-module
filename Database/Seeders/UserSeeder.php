...
//        factory(User::class, 3)->states('superuser')->create();
        ...
        $ecokoerierUser = User::updateOrCreate([
            'username' => 'ecokoerier'
        ],[
            'first_name' => 'Ecokoerier',
            'last_name' => 'Mechelen',
            'permissions' => '{}',
            'password' => bcrypt("test"),
            'activated' => 1,
        ...
        if (!$ecokoerierUser->groups()->exists()) {
            $klusbibDeliveryGroup->users()->save($ecokoerierUser);
        }
