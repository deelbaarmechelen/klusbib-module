...
class Reservations
{
    ...
    public function update($delivery_id, array $params)
    {
        ...
        Log::debug("update of delvery with id $delivery_id and filteredParams: " . \json_encode($filteredParams));
        return $this->client->put('reservations/' . rawurlencode($delivery_id), $filteredParams);
    }
