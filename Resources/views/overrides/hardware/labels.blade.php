...
<body>
  ...
  $qr_size = ($settings->alt_barcode_enabled=='1') && ($settings->alt_barcode!='') ? $settings->labels_height - .6 : $settings->labels_height - .3;

  // Limit QR size to max half of label width
  $qr_size = $qr_size > $settings->labels_width / 2 ? $settings->labels_width / 2 : $qr_size;
